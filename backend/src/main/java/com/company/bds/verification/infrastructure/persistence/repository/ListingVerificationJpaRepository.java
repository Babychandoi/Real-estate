...
public interface ListingVerificationJpaRepository extends JpaRepository<ListingVerificationJpaEntity, UUID> {
    ...
    List<ListingVerificationJpaEntity> findByListingIdOrderByCreatedAtDesc(UUID listingId);

    List<ListingVerificationJpaEntity> findByStatusOrderByCreatedAtDesc(VerificationStatus status);
