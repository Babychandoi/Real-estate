          ...
          {!documents ? (
            ...
            >
              ...
              <input
                ...
                className="min-h-11 flex-1 rounded-lg border border-outline-variant bg-white px-3 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
              />
              <button
                disabled={unlocking}
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                {DOCUMENTS.map(({ field, label }) => (
                  ...
                  >
                    ...
                    <figcaption className="border-t border-outline-variant/40 px-4 py-3 text-sm font-semibold text-on-surface">
                      {label}
                    </figcaption>
                  </figure>
                ))}
      ...
      <form onSubmit={submit} className="mt-6 space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {DOCUMENTS.map(({ field, label, help }) => (
            <label
              key={field}
              className="flex min-h-48 cursor-pointer flex-col justify-between rounded-2xl border bg-white p-5 focus-within:ring-2 focus-within:ring-primary"
            >
              <span>
